...
// ---------------------------------------------------------------------------
// Jobraker Recruiter events — the shared queue feeding the live-note + bg-task consumers.
//
...
export const JobrakerRecruiterEventSchema = z.object({
...
export type JobrakerRecruiterEvent = z.infer<typeof JobrakerRecruiterEventSchema>;
