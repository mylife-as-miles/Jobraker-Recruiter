...
// `./events.ts` as `JobrakerRecruiterEventSchema` / `Pass1OutputSchema`. These re-exports
// keep older import paths working for one release; remove after nothing imports
// them from here.
export { JobrakerRecruiterEventSchema as KnowledgeEventSchema, Pass1OutputSchema } from './events.js';
export type { JobrakerRecruiterEvent as KnowledgeEvent, Pass1Output } from './events.js';
